...
library NftConfiguration {
  uint256 public constant LTV_MASK =                   0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF0000; // prettier-ignore
  uint256 public constant LIQUIDATION_THRESHOLD_MASK = 0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF0000FFFF; // prettier-ignore
  uint256 public constant LIQUIDATION_BONUS_MASK =     0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF0000FFFFFFFF; // prettier-ignore
  uint256 public constant ACTIVE_MASK =                0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFF; // prettier-ignore
  uint256 public constant FROZEN_MASK =                0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFDFFFFFFFFFFFFFF; // prettier-ignore
  uint256 public constant REDEEM_DURATION_MASK =       0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF00FFFFFFFFFFFFFFFF; // prettier-ignore
  uint256 public constant AUCTION_DURATION_MASK =      0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF00FFFFFFFFFFFFFFFFFF; // prettier-ignore
  uint256 public constant REDEEM_FINE_MASK =           0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF0000FFFFFFFFFFFFFFFFFFFF; // prettier-ignore
  uint256 public constant REDEEM_THRESHOLD_MASK =      0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF0000FFFFFFFFFFFFFFFFFFFFFFFF; // prettier-ignore

  /// @dev For the LTV, the start bit is 0 (up to 15), hence no bitshifting is needed
  uint256 public constant LIQUIDATION_THRESHOLD_START_BIT_POSITION = 16;
  uint256 public constant LIQUIDATION_BONUS_START_BIT_POSITION = 32;
  uint256 public constant IS_ACTIVE_START_BIT_POSITION = 56;
  uint256 public constant IS_FROZEN_START_BIT_POSITION = 57;
  uint256 public constant REDEEM_DURATION_START_BIT_POSITION = 64;
  uint256 public constant AUCTION_DURATION_START_BIT_POSITION = 72;
  uint256 public constant REDEEM_FINE_START_BIT_POSITION = 80;
  uint256 public constant REDEEM_THRESHOLD_START_BIT_POSITION = 96;

  uint256 public constant MAX_VALID_LTV = 65535;
  uint256 public constant MAX_VALID_LIQUIDATION_THRESHOLD = 65535;
  uint256 public constant MAX_VALID_LIQUIDATION_BONUS = 65535;
  uint256 public constant MAX_VALID_REDEEM_DURATION = 255;
  uint256 public constant MAX_VALID_AUCTION_DURATION = 255;
  uint256 public constant MAX_VALID_REDEEM_FINE = 65535;
  uint256 public constant MAX_VALID_REDEEM_THRESHOLD = 65535;
